...
$destino = $_SERVER['DOCUMENT_ROOT'] . '/huella/img/contenido_ex/';
...
$sql = "INSERT INTO contenido_exclusivo (Nombre,Descripcion,Ruta,Tipo) VALUES (:nombre,:descripcion,:ruta,:tipo)";
