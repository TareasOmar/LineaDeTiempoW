    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo CONTENIDO_MANAGER ?>"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> CONTENIDO</a></li>
                <li><a href="<?php echo SHOP_MANAGER ?>"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> SHOP</a></li>
                <li><a href="<?php echo SERVICIOS_MANAGER ?>"><span class="glyphicon glyphicon-camera" aria-hidden="true"></span> SERVICIOS</a></li>
            </ul>
